...
typedef    s3eBool(*s3eIOSControllerGetReportsAbsoluteDpadValues_t)();
typedef       void(*s3eIOSControllerSetReportsAbsoluteDpadValues_t)(s3eBool value);
typedef    s3eBool(*s3eIOSControllerGetAllowsRotation_t)();
typedef       void(*s3eIOSControllerSetAllowsRotation_t)(s3eBool value);
